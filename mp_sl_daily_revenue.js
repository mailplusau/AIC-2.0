 ...
 function(ui, email, runtime, search, record, http, log, redirect, format) {
     ...
     function onRequest(context) {  
         ...
         if (context.request.method === 'GET') {
             ...
             var inlineQty = '<br><div class="container" style="padding: 0px"><style>fieldset { padding: 0; }</style><div class="inner" ><style>table#daily_revenue {font-size:12px; font-weight:bold; text-align:center; border-color:#379E8F; display:block; overflow-x:auto; white-space:nowrap;} #daily_revenue tr:nth-child(even){background-color: #f2f2f2;}</style><table border="0" cellpadding="10" id="daily_revenue" cellspacing="0" class="table table-responsive table-striped table-bordered customer tablesorter" style="table-layout: fixed; width: 100%;"><thead style="color: white;background-color: #379E8F;"><tr><th class="cell" style="text-align:left;"><b>Date</b></th>';
             ...
             //TOTAL SECTION
             inlineQty += '<tfoot style="color: white;background-color: #379E8F;">';
            ...
            //  });
             ...
             form.clientScriptFileId = 4736787; //SB cl_id = 4736787, PROD cl_id = 
